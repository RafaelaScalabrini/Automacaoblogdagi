...
public class MyStepdefs {
    ...
    public MyStepdefs() {
        ...
        @Dado("^que o usuário está na página inicial do site do blog do Agi: https://blogdoagi\\.com\\.br/$", () -> {
            private void que_o_usuário_está_na_página_inicial_do_site(String s, Object o) {
                pesquisa = new Pesquisa(driver);
            }
        })
        @Quando("^o usuário realiza uma pesquisa por uma carreira$", () -> {
            private void o_usuário_realiza_uma_pesquisa_por_uma_arreira(String s, Object o) {
                pesquisa.Pesquisa();
            }
        })
        @Então("^uma lista de resultados relacionados à pesquisa é exibida$", () -> {
            private void uma_lista_de_resultados_relacionados_à_pesquisa_é_exibida(String s, Object o) {
                pesquisa.Pesquisa();
            }
        })
        @Dado("^que o usuário está na página inicial do Blog do Agi$", () -> {
            private void que_o_usuário_está_na_página_inicial(String s, Object o) {
        ...
        @Quando("^o usuário insere seu endereço de e-mail na caixa de inscrição de newsletter e clica no botão \"([^\"]*)\"$", (String arg0) -> {
            private void o_usuário_insere_seu_endereço_de_e_mail(String s, Object o) {
       ...
       @Então("^o usuário recebe uma mensagem de confirmação de inscrição e é adicionado à lista de assinantes da newsletter$", () -> {
           private void o_usuário_recebeumamensagem(String s, Object o) {
               inscrever.fillOutTheInscrever();
           })
